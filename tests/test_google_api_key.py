...
from dohasecuritiesstockai.llm_clients.google_client import GoogleClient
...
class TestGoogleApiKeyStandardization(unittest.TestCase):
    ...
    @patch("dohasecuritiesstockai.llm_clients.google_client.NormalizedChatGoogleGenerativeAI")
