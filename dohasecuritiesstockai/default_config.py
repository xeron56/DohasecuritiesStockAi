...
_ENV_OVERRIDES = {
    ...
    "TRADINGAGENTS_SOCIAL_MEDIA_ENABLED": "social_media_enabled",
    "TRADINGAGENTS_MACRO_DATA_ENABLED":   "macro_data_enabled",
    "TRADINGAGENTS_PREDICTION_MARKETS_ENABLED": "prediction_markets_enabled",
    "TRADINGAGENTS_DSE_GATEWAY_URL":       "dse_gateway_url",
    "TRADINGAGENTS_DSE_REQUEST_TIMEOUT":   "dse_request_timeout",
    "TRADINGAGENTS_DSE_VERIFY_SSL":        "dse_verify_ssl",
    "TRADINGAGENTS_DSE_BENCHMARK_TICKER": "dse_benchmark_ticker",
...
DEFAULT_CONFIG = _apply_env_overrides({
    ...
    # LLM settings
    # Bangladesh starter profile: OpenRouter is the out-of-box provider, using
    # Gemini models through its OpenAI-compatible endpoint. To call Gemini
    # directly instead, set provider=google and use the same unprefixed model
    # names with GOOGLE_API_KEY.
    "llm_provider": "openrouter",
    "deep_think_llm": "google/gemini-3.1-pro-preview",
    "quick_think_llm": "google/gemini-3.5-flash",
    ...
    # Market profile and analyst feature gates. Social platforms, US macro
    # series, and prediction markets are intentionally off for the Bangladesh
    # deployment; the DSE News Analyst remains enabled and consumes company +
    # exchange-wide disclosures from the brokerage gateway.
    "market_profile": "bangladesh_dse",
    ...
    "dse_request_timeout": 30,
    "dse_verify_ssl": True,
    "dse_benchmark_ticker": "DSEX",
    ...
    "data_vendors": {
        "core_stock_apis": "dse",            # Options: dse, alpha_vantage, yfinance
        "technical_indicators": "dse",       # Computed from authenticated DSE candles
        "fundamental_data": "dse",           # DSE company/financial disclosure APIs
        "news_data": "dse",                  # Stock-wise + exchange-wide DSE news only
    ...
    "benchmark_map": {
        ".DSE": "DSEX",       # Dhaka Stock Exchange broad-market index
